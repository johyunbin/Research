...
## 세 번째 갈래 — OpenAlex 보조검색 (2026-08-06 이행)

등록 프로토콜이 OpenAlex를 보조 식별원으로 명시했으나, 3-DB 풀에 없는 고유분이 스크리닝되지
않은 채 남아 있었다(자체 감사에서 발견). 뒤늦게 전수 이행했다. 상세 = `oa_supp_summary.md`.

```
  OpenAlex 고유 레코드 ...................... 352
  기존 풀·인용추적·코퍼스 중복 제거 ......... −23
                                              ↓
  제목·초록 스크리닝 ........................ n = 329
  배제 ...................................... −314
    비실증(서평·사설·논평·부고) ............. 147
  ...
  미확보 .................................... −8
                                              ↓
  전문 평가 ................................. n = 5
  배제 ...................................... −3   (언어 2·행태 아웃컴 없음 1)
                                              ↓
  포함 ...................................... n = 2
```

**이 갈래의 산출은 2편이고 메타분석에는 기여하지 않는다**(둘 다 질적 연구). 그럼에도 이행한 것은
등록한 식별원이기 때문이다. 배제 사유에서 **비실증이 45%**를 차지하는데 서평·사설·부고까지
포함된다 — OpenAlex가 3-DB보다 훨씬 넓게 색인하므로 **"3-DB에 없다"가 곧 누락을 뜻하지 않는다**는
경험적 근거다.

⚠️ **문헌유형·언어는 메타데이터로 판단할 수 없다.** 전문 확보 5편 중 2편은 OpenAlex가
`language=en`으로 기록했으나 실제 본문이 한국어·일본어였다(영문은 제목·초록뿐).
...
3. **보조 식별원**: OpenAlex 검색으로 3개 DB 미포착 352건을 별도 확인(`openalex_supplement_*.csv`).
   **2026-08-06 전수 이행 완료** — 위 '세 번째 갈래' 절 참조(포함 2편).
