...
# 8월 DB 전문 배제 16건 — ft_verdicts_v2.reason 서술을 등록본 배제 기준 번호 순서로 정확히 재배정(2026-09-18 결정:
#   원 수기 집계 7·6·1·1·1 보존보다 정확성 우선). 909(설계 스튜디오 성찰 리뷰)=X5 비실증, 948(지각·평가뿐)=X4,
#   729(사적 주택 마당·음환경 측정 없음)=처음 해당하는 X2. 결과 X2 8 · X4 6 · X5 2.
AUG_DB_EXCLUSION = {
    "234": "X2", "613": "X2", "729": "X2", "779": "X2", "880": "X2", "912": "X2", "1141": "X2", "1154": "X2",
    "648": "X4", "770": "X4", "811": "X4", "948": "X4", "981": "X4", "1253": "X4",
    "909": "X5", "1243": "X5",
}
SPECIAL_CATEGORY = {}
...
NR_LABEL = {"closed": "Paywalled (not accessible)", "nodoi": "No DOI (not located)",
